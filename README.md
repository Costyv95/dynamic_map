...
- **Quick actions** — `quick_actions:` in the card config adds chips at the bottom of the map: `{name, icon, service, data, confirm}` or the shorthand `{entity: switch.pump}` (toggle, chip lit while on).
